    ...
    <form className="publicform loginform bg-white rounded-lg">
      <div>
        ...
        <div className="text-gray-700 text-xs font-medium font-['Montserrat']">
          Welcome back !! We happy to see again
        </div>
      </div>
      <div>
        <div>
        ...
        <div className="flex flex-row justify-between items-center">
          ...
          <div>
            <Link to="/forgetpassword" className="text-gray-700 text-xs font-normal font-['Montserrat'] underline">
      ...
      <div>
        ...
        <Link to="/" className="text-gray-700 text-xs font-semibold font-['Montserrat'] underline">
          Sign up
        </Link>
      </div>
    </form>
