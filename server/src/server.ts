...
import { ApiError, IErrorRes } from './shared/global/middlewares/errorMiddleware';
...
export class ServerInit {
    ...
    private securityMiddleware(app: Application): void {
        ...
        app.use(cors({ origin: config.BASE_URL, credentials: true, optionsSuccessStatus: 200, methods: ['GET', 'POST', 'PUT', 'DELETE', 'OPTIONS'] }));
    }
